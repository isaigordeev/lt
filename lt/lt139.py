...
def mark_word(s: str, wordDict: list[str]):
    ...
    for word_ in wordDict:
        start_idx = 0
        while True:
            start_idx = s.find(word_, start_idx)
            if start_idx == -1:
                break
...
if __name__ == "__main__":
    ...
    print(traverse_segments(s, dict_, segs_, wordDict))
